      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            The game against {opponent?.username || 'your opponent'} has concluded.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter className="sm:justify-center">
          <Button variant="secondary" onClick={handleClose}>Go to Lobby</Button>
          <Button onClick={handleRematch} disabled={opponent?.userId === 'christopher'}>Request Rematch</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
